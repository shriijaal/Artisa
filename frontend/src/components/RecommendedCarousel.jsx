  ...
  return (
    <section className="relative">
      ...
      <div className="relative group/carousel py-5">
        ...
        <button
          onClick={() => scroll('left')}
          className="absolute left-2 top-1/2 -translate-y-[95%] z-20 h-10 w-10 rounded-full bg-white/90 backdrop-blur-sm border border-stone-200 flex items-center justify-center text-stone-600 hover:text-stone-900 hover:bg-white shadow-sm transition-all opacity-0 group-hover/carousel:opacity-100 cursor-pointer"
        >
      ...
      <button
        ...
        className="absolute right-2 top-1/2 -translate-y-[95%] z-20 h-10 w-10 rounded-full bg-white/90 backdrop-blur-sm border border-stone-200 flex items-center justify-center text-stone-600 hover:text-stone-900 hover:bg-white shadow-sm transition-all opacity-0 group-hover/carousel:opacity-100 cursor-pointer"
      >
        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
